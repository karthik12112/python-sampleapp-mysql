...
db = mysql.connector.connect(
  host="{}".format(secret['host']),
  user="{}".format(secret['username']),
  password="{}".format(secret['password'])
)
...
def hello():
    ...
    return "<body style='background-color:powderblue;font-size:30px;'>This is a heading</body>"
